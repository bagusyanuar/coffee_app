...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Kategori Menu</p>
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/kategori/edit/{{ $v->id }}" class="btn btn-sm btn-warning btn-edit" data-id="{{ $v->id }}"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
